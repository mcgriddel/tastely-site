  ...
  return `
    <div class="actions actions--compact">
      ...
      <button class="pill" type="button" data-share-action="share">
        <svg viewBox="0 0 24 24" fill="none"><path d="M12 3V15M12 3L7 8M12 3L17 8M5 16Q12 22 19 16" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
        Share
      </button>
    </div>`;
}
...
(function(){
  ...
  var ACTION_ICONS = {
    ...
    share: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 3V15M12 3L7 8M12 3L17 8M5 16Q12 22 19 16" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>',
